...
{
    public abstract class FrameWorkWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FrameWorkWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FrameWorkWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FrameWorkDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FrameWorkDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FrameWorkDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FrameWorkDbContext, Task<T>> func)
        {
            T result;
